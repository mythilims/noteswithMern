...
const user ={
  ...
  const userDetails = await login('/users/login',user);
  if(userDetails.success){
  setToken(userDetails.token);
  setUser(userDetails.userDetails);
  navigator('/notesDashboard')
  }
  ...
  return (
    <>
      <div
        className="grid grid-cols-1 md:grid-cols-9 w-full h-screen shadow-lg  login_bg_color
